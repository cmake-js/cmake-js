...
function findVisualStudio (configMsvsVersion, callback) {
  const finder = new VisualStudioFinder(configMsvsVersion,
    callback)
  finder.findVisualStudio()
}

function VisualStudioFinder (configMsvsVersion, callback) {
