...
Object.defineProperties(Dist.prototype, {
    internalPath: {
        get: function() {
            return path.join(
                environment.home,
                ".cmake-js",
                (this.targetOptions.isIOJS ? "iojs" : "node") + "-" + this.targetOptions.architecture,
                "v" + this.targetOptions.runtimeVersion);
        }
    },
    externalPath: {
        get: function () {
            if (this.targetOptions.isIOJS) {
    ...
    winLibPath: {
        get: function () {
            return path.join(this.winLibDir, (this.targetOptions.isIOJS ? "iojs" : "node") + ".lib");
        }
    }
});
...
Dist.prototype._downloadTar = function (sums) {
    ...
    var fn = (self.targetOptions.isIOJS ? "iojs" : "node") + "-v" + self.targetOptions.runtimeVersion + ".tar.gz";
...
Dist.prototype._downloadLib = function (sums) {
    ...
    var fn = (self.targetOptions.isIOJS ? "iojs" : "node") + ".lib";
    var subDir = (self.targetOptions.isX64 ? "win-x64" : "win-x86");
