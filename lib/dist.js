...
Object.defineProperties(Dist.prototype, {
    ...
    externalPath: {
        get: function () {
            switch (this.targetOptions.runtime) {
                ...
                case "electron": 
                    return "http://atom.io/download/atom-shell/v"+this.targetOptions.runtimeVersion+"/";
                default:
    ...
    winLibDir: {
        get: function () {
            if (this.targetOptions.runtime === "nw" || this.targetOptions.runtime === "electron") {
    ...
    winLibPath: {
        get: function () {
            return path.join(this.winLibDir, (this.targetOptions.runtime === "electron" ? "node" : this.targetOptions.runtime) + ".lib");
        }
    }
});
...
Dist.prototype._downloadTar = function (sums) {
    ...
    else if (self.targetOptions.runtime === "electron") {
