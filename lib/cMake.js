...
class CMake {
    ...
    D.push({ CMAKEJS_NODE_DEV:       'ON' })  // cmake-js::node-dev
    D.push({ CMAKEJS_NODE_API:       'ON' })  // cmake-js::node-api
    D.push({ CMAKEJS_NODE_ADDON_API: 'ON' })  // cmake-js::node-aaddon-pi
    D.push({ CMAKEJS_CMAKEJS:        'ON' })  // cmake-js::cmake-js (required for 'cmakejs_create_napi_addon()')
