...
Toolset.prototype._getTopSupportedVisualStudioGenerator = async(function*() {
    ...
    const vswhereGenerator = getGeneratorFromVSWhere();
    if (vswhereGenerator) {
        return vswhereGenerator;
    }
...
/**
 * Returns the highest fully installed Visual Studio generator version, or `null` 
 * Does so using the command: `vswhere.exe -property installationVersion` which is not available without a full installation
 */
function getGeneratorFromVSWhere() {
