...
BuildSystem.prototype._invokeCMake = async(function* (method, options) {
    try {
        yield this._ensureInstalled();
        return yield this.cmake[method](options);
    }
    catch (e) {
        this._showError(e);
        throw e;
...
BuildSystem.prototype.getConfigureCommand = function (options) {
    return this._invokeCMake("getConfigureCommand", options);
};

BuildSystem.prototype.configure = function (options) {
    return this._invokeCMake("configure", options);
};
...
BuildSystem.prototype.build = function (options) {
    return this._invokeCMake("build", options);
};
...
BuildSystem.prototype.reconfigure = function (options) {
    return this._invokeCMake("reconfigure", options);
};

BuildSystem.prototype.rebuild = function (options) {
    return this._invokeCMake("rebuild", options);
};

BuildSystem.prototype.compile = function (options) {
    return this._invokeCMake("compile", options);
};
