...
CMake.getGenerators = async($traceurRuntime.initGeneratorFunction(function $__17(options) {
  var arch,
      gens,
      stdout$__16,
      capabilities,
    ...
    while (true)
      switch ($ctx.state) {
        case 0:
          ...
          break;
        case 30:
          $ctx.state = (CMake.isAvailable(options)) ? 11 : 24;
          break;
        case 11:
          $ctx.pushTry(9, null);
          $ctx.state = 12;
        ...
        case 12:
          $ctx.state = 2;
          return processHelpers.exec((options.cmakePath || "cmake") + " -E capabilities");
        case 2:
          stdout$__16 = $ctx.sent;
          $ctx.state = 4;
          break;
        case 4:
          capabilities = JSON.parse(stdout$__16);
          $ctx.state = 8;
          break;
        case 8:
          $ctx.returnValue = capabilities.generators.map(function(x) {
            return x.name;
          });
          $ctx.state = -2;
          break;
...
CMake.prototype.getConfigureCommand = async($traceurRuntime.initGeneratorFunction(function $__18() {
  var $__1,
      command,
      D,
      incPaths,
    ...
    while (true)
      switch ($ctx.state) {
        ...
        case 4:
          ...
          srcPaths = [];
          if (environment.isWin) {
            delayHook = path.normalize(path.join(__dirname, '..', 'cpp', 'win_delay_load_hook.cc'));
...
CMake.prototype.configure = async($traceurRuntime.initGeneratorFunction(function $__19() {
  var listPath,
      command,
      cwd,
      e;
...
CMake.prototype.ensureConfigured = async($traceurRuntime.initGeneratorFunction(function $__20() {
  var e;
  return $traceurRuntime.createGeneratorInstance(function($ctx) {
    while (true)
      switch ($ctx.state) {
...
CMake.prototype.build = async($traceurRuntime.initGeneratorFunction(function $__21() {
  var buildCommand;
  return $traceurRuntime.createGeneratorInstance(function($ctx) {
    while (true)
      switch ($ctx.state) {
...
CMake.prototype.reconfigure = async($traceurRuntime.initGeneratorFunction(function $__22() {
  return $traceurRuntime.createGeneratorInstance(function($ctx) {
    while (true)
      switch ($ctx.state) {
        case 0:
...
CMake.prototype.rebuild = async($traceurRuntime.initGeneratorFunction(function $__23() {
  return $traceurRuntime.createGeneratorInstance(function($ctx) {
    while (true)
      switch ($ctx.state) {
        case 0:
...
CMake.prototype.compile = async($traceurRuntime.initGeneratorFunction(function $__24() {
  var e;
  return $traceurRuntime.createGeneratorInstance(function($ctx) {
    while (true)
      switch ($ctx.state) {
