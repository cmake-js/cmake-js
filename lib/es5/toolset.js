...
Toolset.prototype._getTopSupportedVisualStudioGenerator = async($traceurRuntime.initGeneratorFunction(function $__3() {
  var hasWindowsBuildToolsPackage,
      programFilesPath,
      vswhereCommand,
      vswhereOutput,
      version,
    ...
    while (true)
      switch ($ctx.state) {
        case 0:
          ...
          hasWindowsBuildToolsPackage = false;
          try {
            hasGlobalPackage("windows-build-tools");
            hasWindowsBuildToolsPackage = true;
          } catch (e) {
            console.log("no windows-build-tools", e);
          }
        ...
        case 2:
          ...
          break;
        case 4:
          $ctx.state = (!vswhereOutput) ? 7 : 9;
          break;
        case 7:
          $ctx.state = (hasWindowsBuildToolsPackage) ? 5 : 6;
          break;
        case 5:
          $ctx.returnValue = "Visual Studio 15 2017";
          $ctx.state = -2;
          break;
        case 6:
        ...
        case 15:
          ...
          break;
        case 17:
          $ctx.state = (!cppBuildToolsOutput || cppBuildToolsOutput.indexOf("installationVersion: " + version) === -1) ? 18 : 19;
          break;
        case 18:
          $ctx.returnValue = null;
          $ctx.state = -2;
