    ...
    while (true)
      switch ($ctx.state) {
        ...
        case 18:
          ...
          break;
        case 10:
          $__15 = processHelpers.exec;
          $__16 = $__15.call(processHelpers, ("\"" + vswhereCommand + "\" -latest -products * -requires Microsoft.VisualStudio.Component.VC.Tools.x86.x64 -property installationVersion"));
          $ctx.state = 6;
          break;
        case 6:
          $ctx.state = 2;
